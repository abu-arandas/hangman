...
class ScoreScreen extends StatelessWidget {
  ...
  List<TableRow> createRow(var query) {
    ...
    for (var i = 0; i < numOfRows && i < 10; i++) {
      ...
      var scoreDate = formatDate(DateTime(int.parse(date[0]), int.parse(date[1]), int.parse(date[2])), [yy, '-', M, '-', d]);
      ...
      rows.add(TableRow(children: [item, item1, item2]));
    }
                  ...
                  children: <Widget>[
                    Stack(
                      ...
                      children: <Widget>[
                        ...
                        Center(
                          child: Container(
                            margin: const EdgeInsets.fromLTRB(8, 10, 8, 15),
                            child: const Text(
                              'High Scores',
                              style: TextStyle(
                                color: Colors.white,
